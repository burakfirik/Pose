...
<div style="position:relative;width:100%;">
	...
	<div style="width:960px;margin-top:5px;margin-left:auto;margin-right:auto">
		...
		<div style="width:960px;">
			<div id="leftcolumn">
				<h2 class="left"><span class="left_h2" style="color:#92B901">HTML</span> Tutorials</h2>
				...
				<br>
				<h2 class="left"><span class="left_h2" style="color:#92B901">Browser</span> Scripting</h2>
				...
				<br>
				<h2 class="left"><span class="left_h2" style="color:#92B901">Server</span> Scripting</h2>
				...
				<a href="dotnetmobile/default.asp" target="_top">Learn .NET 
				Mobile</a><br>
				<br>
				<h2 class="left"><span class="left_h2" style="color:#92B901">XML</span> Tutorials</h2>
				...
				<br>
				<h2 class="left"><span class="left_h2" style="color:#92B901">Web</span> Services</h2>
				...
				<br>
				<h2 class="left"><span class="left_h2" style="color:#92B901">Web</span> Building</h2>
			...
			<div id="maincolumn">
				...
				<div style="width:509px;float:left;padding-right:5px;">
					<div id="headerdiv1">
						...
						<div style="height:100px;">
							...
							<img src="images/icon_doc.gif" width="74" height="77" style="border:0;float:left;margin-right:10px;" alt="Free Online Web Tutorials"></a>
				...
				<div id="frontbox">
					...
					<ul>
					<li><a href="tags/default.asp">HTML 4.01</a></li>
					<li><a href="html5/html5_reference.asp">HTML5</a></li>
				...
				<div id="tryit_box">
					...
					<div style="width:300px;float:left;">
						...
						<div>With our &quot;Try it Yourself&quot; editor you can experiment with HTML, CSS, XML, JavaScript, and see the result in your browser.
				...
				<div style="margin-top:30px;margin-left:23px;width:370px;float:left;">
					...
					<div style="width:240px;float:left;">
						...
						<div>w3schools.com offer an online certification program, where you can become certified in the most popular web topics.
							<div style="margin-top:7px;width:200px;">
				...
				<div style="margin-top:35px;margin-left:55px;width:200px;float:left;">
					...
					<a href="html5/html5_reference.asp"><span class="frontraquo">&raquo;</span> HTML5 Reference</a><br>
				...
				<div style="margin-top:47px;margin-left:65px;width:400px;float:left;background-color:#f1f1f1;border:1px solid #d3d3d3;padding:20px;padding-right:0;">
					<div style="width:130px;float:left;margin-right:15px;">
						<a href="html5/default.asp"><img src="images/html5_badge_128.gif" width="128" height="128" style="border:0;" alt="HTML5"></a>
					</div>
					<div style="width:210px;float:left;">
						<h2 class="frontheader" style="margin-top:0">HTML5</h2>
						<div>w3schools.com was converted<br /> to HTML5 in October 2011.<br><br>
						<div style="margin-top:7px;width:200px;">
						<a style="font-weight:bold;" href="html5/default.asp">Visit our HTML5 tutorial <span class="frontraquo">&raquo;</span></a>
						</div>
						</div>
					</div>
				</div>
	...
	<div style="width:100%;clear:both;margin:0;padding:0;background-color:transparent;position:relative;top:65px;">
