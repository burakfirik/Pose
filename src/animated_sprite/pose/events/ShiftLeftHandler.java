 ...
 * @author burak
 */
public class ShiftLeftHandler implements ActionListener {

    /**
     * Called when the user requests to reorder new Pose  via the
     * new pose button, this will make sure no work is lost
     * and then close the application.this will shift the selected pose 
     * towards left
     * 
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        spriteFileManager.requestLeftRight();
    }
