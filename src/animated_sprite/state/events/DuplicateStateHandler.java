...
/**
 * This handler responds to when the user wants to duplicate a state 
...
/**
     * Called when the user wants to duplicate a state  via the
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        spriteFileManager.requestDuplicateState();
    }
